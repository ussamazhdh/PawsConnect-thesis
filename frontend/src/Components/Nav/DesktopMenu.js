        ...
        {missing && (
          <div className="ml-[20px]">
            ...
            <ProfileMenuNestedItem
              ...
              setShowProfileMenu={setShowProfileMenu}
              link={
                userInfo.role && userInfo.role[0] && userInfo.role[0].id === 1
                  ? `/admin/missingposts`
...
const AnonymousUserLeftSection = ({ theme }) => {
  return (
    <div className="flex justify-between ml-10 gap-4 flex-nowrap">
      {navItemsLeft.map((item) => (
        <Link
          to={item.link}
          key={item.link}
          className="menu-item-border flex items-center justify-center gap-1.5 mx-2 cursor-pointer my-5 rounded-full whitespace-nowrap"
        >
          <img
          ...
          <h1
            className={
              theme
                ? 'px-2 text-primary font-semibold text-sm'
                : 'px-2 text-offwhite font-semibold text-sm'
            }
          >
            {item.title}
          </h1>
...
export default function DesktopMenu({ theme }) {
  ...
  return (
    <div className="menu lg:flex justify-between w-3/4 hidden flex-nowrap">
      <div className="flex items-center justify-start gap-3 flex-nowrap">
        {userInfo && userInfo.role && userInfo.role[0] && userInfo.role[0].id === 1 && (
          <Link to="/dashboard">
            <div className="menu-item-border flex items-center justify-center gap-1.5 mx-2 cursor-pointer my-5 rounded-full whitespace-nowrap">
              <img
                src={
                  theme
