...
export default function RegistrationPage() {
  ...
  // Make sure error is always a string for rendering
  const errorMessage =
    typeof error === 'string'
      ? error
  ...
  // On successful registration, go to completion page
  useEffect(() => {
    if (success) {
      ...
      {loading ? (
        ...
        <div className="lg:flex lg:flex-row-reverse justify-between lg:items-center pt-[40px] lg:w-3/4 w-[90vw] mx-auto mt-[150px] mb-[100px]">
          ...
          <div className="lg:w-[50%]">
            ...
            {errorMessage && (
              <Message message={errorMessage} variant="danger" />
            )}
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="request-form-animation mt-4">
