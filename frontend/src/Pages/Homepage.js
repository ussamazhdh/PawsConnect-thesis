    ...
    <>
      {loading ? (
        ...
        <div className=" lg:w-3/4 w-[90vw] mx-auto mt-[100px] lg:mt-[120px] ">
          <div className="bg-gradient-to-r from-[#1B4D3E] to-[#FF7A36]  relative w-full h-[300px] custom-round mb-16 flex items-center justify-between px-6">
            <div className=" mt-[-100px] lg:mt-[-60px] z-[10]">
              <h1 className="text-white font-bold text-[20px] lg:text-[26px]  mb-2">
                PawConnect Encourages Charity for Animals
              </h1>
              <p className="text-white text-[14px] lg:w-[70%]">
                Adopting an animal means giving love and safety to a life that cannot protect itself. Helping a lost animal find its way back home is a quiet, noble act of compassion. And offering a donation to a sick or injured animal is more than kindness—it is a chance to save a precious life that depends on the care of others.
              </p>
            </div>
